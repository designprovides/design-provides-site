    ...
    <>
        ...
        onSubmit = {( values, { setSubmitting, resetForm } ) => {
            ...
            fetch(form.action, {
                ...
                if (response.ok) {
                    setIsSubmittedSuccessfully(true); // Update state here
                    resetForm({});
                } else {
        ...
        {isSubmittedSuccessfully && (
                <div className="form-status alert-success mil-mb-90" id="contactFormStatus" style={{ backgroundColor: 'lightgreen', color: 'white', padding: '10px', borderRadius: '5px' }}>
